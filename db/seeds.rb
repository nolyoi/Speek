...
admin = User.create(name: "Nolan", email: "nolyoi@hey.com", username: "nolyoi", password: "password", password_confirmation: "password")
...
30.times do
  ...
  user.community_memberships.create(community_id: 1)
